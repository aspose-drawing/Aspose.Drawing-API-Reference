...
| static [FromStream](../../system.drawing/image/fromstream)(Stream) | Creates an Image from the specified data stream. |
| static [FromStream](../../system.drawing/image/fromstream)(Stream, bool) | Creates an Image from the specified data stream, optionally using embedded color management information in that stream. |
