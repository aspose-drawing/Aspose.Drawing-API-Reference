...
| static [DarkGray](../../system.drawing/color/darkgray) { get; } | Gets a system-defined color that has an ARGB value of #FFA9A9A9. |
...
| static [LawnGreen](../../system.drawing/color/lawngreen) { get; } | Gets a system-defined color that has an ARGB value of #FF7CFC00. |
...
| static [OliveDrab](../../system.drawing/color/olivedrab) { get; } | Gets a system-defined color that has an ARGB value of #FF6B8E23. |
...
| static [Violet](../../system.drawing/color/violet) { get; } | Gets a system-defined color that has an ARGB value of #FFEE82EE. |
...
| Name | Description |
| --- | --- |
| static [FromArgb](../../system.drawing/color/fromargb)(int) | Creates a Color structure from a 32-bit ARGB value. |
| static [FromArgb](../../system.drawing/color/fromargb)(int, Color) | Creates a Color structure from the specified Color structure, but with the new specified alpha value. Although this method allows a 32-bit value to be passed for the alpha value, the value is limited to 8 bits. |
| static [FromArgb](../../system.drawing/color/fromargb)(int, int, int) | Creates a Color structure from the specified 8-bit color values (red, green, and blue). The alpha value is implicitly 255 (fully opaque). Although this method allows a 32-bit value to be passed for each color component, the value of each component is limited to 8 bits. |
| static [FromArgb](../../system.drawing/color/fromargb)(int, int, int, int) | Creates a Color structure from the four ARGB component (alpha, red, green, and blue) values. Although this method allows a 32-bit value to be passed for each component, the value of each component is limited to 8 bits. |
...
| [Equals](../../system.drawing/color/equals)(Color) | Tests whether the specified color is equivalent to this color. |
| override [Equals](../../system.drawing/color/equals)(object) | Tests whether the specified object is equivalent to this color. |
