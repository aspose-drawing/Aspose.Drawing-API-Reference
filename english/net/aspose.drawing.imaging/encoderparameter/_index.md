...
description: Aspose.Drawing.Imaging.EncoderParameter class. Used to pass a value or an array of values to an image encoder
type: docs
weight: 670
...
| Name | Description |
| --- | --- |
| [Encoder](../../aspose.drawing.imaging/encoderparameter/encoder/) { get; set; } | Gets or sets the Encoder object associated with this EncoderParameter object. The Encoder object encapsulates the globally unique identifier (GUID) that specifies the category (for example Quality, ColorDepth, or Compression) of the parameter stored in this EncoderParameter object. |
| [NumberOfValues](../../aspose.drawing.imaging/encoderparameter/numberofvalues/) { get; } | Gets the number of elements in the array of values stored in this EncoderParameter object. |

## Methods

| Name | Description |
| --- | --- |
| [Dispose](../../aspose.drawing.imaging/encoderparameter/dispose/)() | Releases all resources used by this EncoderParameter object. |
