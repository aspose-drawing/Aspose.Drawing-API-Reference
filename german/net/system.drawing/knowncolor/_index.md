...
type: docs
weight: 890
url: /de/net/system.drawing/knowncolor/
---
...
| ActiveCaption | `2` | Die systemdefinierte Hintergrundfarbe der Titelleiste des aktiven Fensters. |
| ActiveCaptionText | `3` | Die systemdefinierte Farbe des Textes in der Titelleiste des aktiven Fensters. |
| AppWorkspace | `4` | Die systemdefinierte Farbe des Anwendungsarbeitsbereichs. Der Anwendungsarbeitsbereich ist der Bereich in einer Ansicht mit mehreren Dokumenten, der nicht von Dokumenten belegt ist. |
| Control | `5` | Die systemdefinierte Flächenfarbe eines 3D-Elements. |
| ControlDark | `6` | Die systemdefinierte Schattenfarbe eines 3D-Elements. Die Schattenfarbe wird auf Teile eines 3D-Elements angewendet, die von der Lichtquelle abgewandt sind. |
| ControlDarkDark | `7` | Die vom System definierte Farbe, die die dunkle Schattenfarbe eines 3D-Elements ist. Die dunkle Schattenfarbe wird auf die Teile eines 3D-Elements angewendet, die die dunkelste Farbe haben. |
| ControlLight | `8` | Die systemdefinierte Farbe, die die helle Farbe eines 3D-Elements ist. Die Lichtfarbe wird auf Teile eines 3D-Elements angewendet, die der Lichtquelle zugewandt sind. |
| ControlLightLight | `9` | Die systemdefinierte Hervorhebungsfarbe eines 3D-Elements. Die Hervorhebungsfarbe wird auf die Teile eines 3D-Elements angewendet, die die hellste Farbe haben. |
| ControlText | `10` | Die systemdefinierte Textfarbe in einem 3D-Element. |
| Desktop | `11` | Die systemdefinierte Farbe des Desktops. |
| GrayText | `12` | Die vom System definierte Farbe von abgeblendetem Text. Deaktivierte Elemente in einer Liste werden in abgeblendetem Text angezeigt. |
| Highlight | `13` | Die systemdefinierte Farbe des Hintergrunds ausgewählter Elemente. Dies umfasst ausgewählte Menüpunkte sowie ausgewählten Text. |
| HighlightText | `14` | Die vom System definierte Farbe des Textes ausgewählter Elemente. |
| HotTrack | `15` | Die systemdefinierte Farbe, die verwendet wird, um ein Hot-Tracking-Element zu kennzeichnen. Durch einfaches Klicken auf ein Hot-Track-Element wird das Element ausgeführt. |
| InactiveBorder | `16` | Die systemdefinierte Farbe des Rahmens eines inaktiven Fensters. |
| InactiveCaption | `17` | Die systemdefinierte Hintergrundfarbe der Titelleiste eines inaktiven Fensters. |
| InactiveCaptionText | `18` | Die systemdefinierte Farbe des Textes in der Titelleiste eines inaktiven Fensters. |
...
| Menu | `21` | Die systemdefinierte Hintergrundfarbe eines Menüs. |
| MenuText | `22` | Die vom System definierte Farbe des Texts eines Menüs. |
...
| ButtonFace | `168` | Die systemdefinierte Flächenfarbe eines 3D-Elements. |
| ButtonHighlight | `169` | Die systemdefinierte Farbe, die die Hervorhebungsfarbe eines 3D-Elements ist. Diese Farbe wird auf Teile eines 3D-Elements angewendet, die der Lichtquelle zugewandt sind. |
| ButtonShadow | `170` | Die systemdefinierte Farbe, die die Schattenfarbe eines 3D-Elements ist. Diese Farbe wird auf Teile eines 3D-Elements angewendet, die von der Lichtquelle abgewandt sind. |
| GradientActiveCaption | `171` | Die vom System definierte Farbe der hellsten Farbe im Farbverlauf der Titelleiste eines aktiven Fensters. |
| GradientInactiveCaption | `172` | Die vom System definierte Farbe der hellsten Farbe im Farbverlauf der Titelleiste eines inaktiven Fensters. |
| MenuBar | `173` | Die systemdefinierte Hintergrundfarbe einer Menüleiste. |
| MenuHighlight | `174` | Die systemdefinierte Farbe, die zum Hervorheben von Menüelementen verwendet wird, wenn das Menü als flaches Menü angezeigt wird. |
