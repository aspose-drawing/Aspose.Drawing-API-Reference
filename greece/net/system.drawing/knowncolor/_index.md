...
| WindowFrame | `25` | Το χρώμα που καθορίζεται από το σύστημα ενός πλαισίου παραθύρου. |
...
| MenuBar | `173` | Το χρώμα του φόντου μιας γραμμής μενού που καθορίζεται από το σύστημα. |
